...
// Returns the private 'App\Repository\PatrimoineRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PatrimoineRepository.php';

return $this->privates['App\\Repository\\PatrimoineRepository'] = new \App\Repository\PatrimoineRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
